...
description: 'Multiple atmospheric chemical transport models of varying complexity are evaluated against UK monitoring data for sulphur and nitrogen deposition, finding that simpler models adequately represent gas concentrations but more complex models better capture aerosol and precipitation chemistry, with total UK deposition estimates varying by ±22–36% across models.'
