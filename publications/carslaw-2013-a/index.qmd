...
categories:
  ...
  - data analysis
  - openair
description: 'K-means clustering applied directly to bivariate polar plots enables automated identification and grouping of emission source types, with the technique validated against known source characteristics at a complex monitoring site and made available in the openair R package.'
