...
categories:
  ...
  - data analysis
description: 'A new Conditional Bivariate Probability Function (CBPF) extends the standard CPF by adding wind speed as a third variable, enabling richer source type characterisation that identifies considerably more sources than existing techniques at a complex site, verified with dispersion modelling and available in the openair R package.'
